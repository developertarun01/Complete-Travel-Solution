...
const Home = () => {
  ...
  const tabs = [
    ...
    },
    {
      ...
      label: "Hotels",
      icon: Hotel,
      bgImage: "/images/bg-hotel.jpg",
    },
    { id: "cars", label: "Cars", icon: Car, bgImage: "/images/bg-car.jpg" },
    {
      id: "cruises",
      label: "Cruises",
      icon: Ship,
      bgImage: "/images/bg-cruise.jpg",
    },
  ];
    ...
    url(${currentBg}) center/cover no-repeat`,
          ...
          <div className="w-full container">
            <div className="tabs w-full ">
              ...
              <div className="w-full">
                <div className="w-full grid grid-cols-4 md:grid-cols-4 lg:grid-cols-4 justify-items-center">
                  {tabs.map((tab) => {
                    const Icon = tab.icon;
                    return (
                      <button
            ...
            {/* Booking Form */}
            <div>
              <div className="bg-white rounded-b-xl shadow-2xl p-4 md:p-4 mb-6">
                {renderForm()}
              </div>
            </div>
          </div>
          ...
          <div className="grid-mine mt-20">
            <div className="section2-card section2-card-1">
              ...
              <div className="section2-card-bottom flex-mine">
                ...
                <div className="section2-card-bottom-right">Book Now</div>
              </div>
            </div>
            <div className="section2-card section2-card-2">
            ...
            <div className="section2-card section2-card-3">
            ...
            <div className="section2-card section2-card-4">
      ...
      <section className="section3">
        <div className="section3-inner container">
          <div className="flex-mine-column">
            <div className="section3-header section3-header-1 ">
              Top International Flight Details
            </div>
            <div className="section3-list flex-mine">
              <img src="/images/am.gif" alt="" width="50px" />
              <h4>MTY - GDL</h4>
              <p>Aug 27 - Sep 01</p>
              <h4>$84.84</h4>
            </div>
          ...
          <div className="flex-mine-column">
            <div className="section3-header section3-header-2">
              Top International Flight Details
            </div>
            <div className="section3-list flex-mine">
              <img src="/images/nk.gif" alt="" width="50px" />
              <h4>LAS - LAX</h4>
              <p>Aug 28 - Sep 01</p>
              <h4>$48.60</h4>
            </div>
      ...
      <section className="section3 container">
        ...
        <div className="section3-inner">
          <div className="flex-mine-column">
            ...
            <div className="section3-list flex-mine">
              <div className="section3-list-details">
                <h3>Quality Hotel Ulstein</h3>
                <p className="mt-10">
                  <i
                    className="fa-solid fa-location-dot fa-sm"
                    style={{ color: "var(--primary)" }}
                  ></i>
                  Sjøgata 10, Ulsteinvik , NO, 6065
                </p>
              </div>
          ...
          <div className="flex-mine-column">
            <div className="section3-header section3-header-4">
